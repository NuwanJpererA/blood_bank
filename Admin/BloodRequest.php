...
<head>
    ...
    <title>Product Edit | Blood Bank</title>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="#description"><i class="icon nalika-edit" aria-hidden="true"></i> Request Form</a></li>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Blood Bank or Hospital Name">
                                                    </div>
                                                    
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="icon nalika-new-file" aria-hidden="true"></i></span>
                                                        <input type="text" class="form-control" placeholder="Reason for Transfusion">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Patient File Number">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="icon nalika-favorites" aria-hidden="true"></i></span>
                                                    ...
                                                    <select name="select" class="form-control pro-edt-select form-control-primary">
												        <option value="opt1">Request Type</option>
														<option value="opt2">Emergency (Immediately)</option>
														<option value="opt3">Urgent (Within 1 hour)</option>
														<option value="opt4">Standard (Within 12 hour)</option>
														<option value="opt5">Group and Save (Within 7 days)</option>
                                                    ...
                                                    <select name="select" class="form-control pro-edt-select form-control-primary">
														...
														<option value="opt3">O-</option>
														<option value="opt4">A+</option>
														<option value="opt5">A-</option>
														<option value="opt6">B+</option>
														<option value="opt3">B-</option>
												        <option value="opt4">AB+</option>
														<option value="opt5">AB-</option>
												    </select><!---Blood Group Selcet END--->
                                                    </div>
                                                    
                                                    <div class="input-group mg-b-pro-edt">
                                                    <!---Blood Type Selcet--->
                                                    <select name="select" class="form-control pro-edt-select form-control-primary">
												        <option value="opt1">Select Blood Type</option>
														<option value="opt2">Packed red cells</option>
														<option value="opt3">FFp</option>
														<option value="opt4">Platelets</option>
														<option value="opt5">Cryoprecipitate</option>
														<option value="opt6">Whole Blood</option>
												    </select><!---Blood Type Selcet END--->
                                                    </div>
                                                </div>
                                            </div><!---SECOND CLOUMN LIST END--->
                                        </div>
                                        <!---BUTTON--->
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="text-center custom-pro-edt-ds">
                                                    <button type="button" class="btn btn-ctl-bt waves-effect waves-light m-r-10">Request
														</button>
