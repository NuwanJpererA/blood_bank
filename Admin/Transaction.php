...
<head>
    ...
    <title>Transaction | Blood Bank</title>
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-cart-inner">
                            <div id="example-basic">
                                <h3>Blood Details</h3>
                                <section>
                                    <h3 class="product-cart-dn">Delivery</h3>
               ...
               if($result)
               {
                   while ($row = mysqli_fetch_assoc($result))
                   {
                    $reqType = $row["request_type"];
                    if($reqType == "Emergency"){
                        $show = "<td><font color='red' size='4px'>".$row['request_type']."</font></td>";
                    }
                    else if ($reqType == "Urgent"){
                        $show = "<td><font color='skyblue' size='4px'>".$row['request_type']."</font></td>";
                    } else{
                        $show = "<td><font  size='4px'>".$row['request_type']."</font></td>";
                       ...
                       <tr>
                           ...
                           <td> <input type="text" class="form-control" value='.$row["units"].'></td>
                           <td>'.$row["date_request"].'</td>
                           <td>'.$row["date_required"].'</td>
                           <td>'.$row["time_required"].'</td>
                           <td>
                                <form action="php/sendOrder.php" method="POST" >
                                <button type="submit" name="submit" data-toggle="tooltip" title="Send" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>
