               ...
               if($result)
               {
                   while ($row = mysqli_fetch_assoc($result))
                   {
                       ...
                       <tr>
                           ...
                           <td><a href="Blood-group.php?getid='.$row["id"].'"><i class="material-icons">&#xE254;</i></a></td>
    ...
    echo'       <div class="edit">   
               ...
               <form action="php/updateBlooddetails.php" method="post" id="togglef1">
                   ...
                   <div class="form-group">
                       ...
                       <div class="form-group">
                            <input type="text" name="blood_group"class="form-control" value="'.$blood_group.'" placeholder="Blood Group">
                        </div>
                   </div>
                    <div class="col-sm-2">
                        <div class="form-group">
