...
if (isset($_GET['getid']))//get id eken ena passwaord eka allagannawa 
{
    ...
    $getdetail = "SELECT * FROM bloodgroup WHERE id = '$getid'";
    ...
    if ($detailcheck == true)
    {
        ...
        $blood_group = $detail_run['blood_group'];
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Appointment</span>
                                            </li>
                                        </ul>
                                    </div><!--PATH END-->
                                </div>
            ...
            <table class="table table-bordered">
               ...
               if($result)
               {
                   while ($row = mysqli_fetch_array($result))
                   {
                        ...
                        $member = "SELECT * FROM member WHERE member.idnumber='$idnumber' ";
                        // var_dump($row);

                        $result2 = mysqli_query($conn, $member);
               ...
               ?>
               <!--<a href="viewAppointment.php?getid='.$row["id"].'"><i class="fa fa-check">&#xE254;</i></a>
               <a href="viewAppointment.php?getid='.$row["id"].'"><i class="fa fa-times">&#xE254;</i></a>-->
                </tbody>
            </table>
